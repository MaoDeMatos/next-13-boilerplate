...
export const metadata: Metadata = {
  ...
  description: 'Meta desc for the first page',
  themeColor: [
    // These are `tailwind.config.js`'s "--main-bg" entries in `daysiui` config
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      suppressHydrationWarning // This is to avoid a runtime error due to the `initTheme` script adding an attribute
    >
      {/* <head /> will contain components hydrated by the metadata constant.
       * Find out more at https://nextjs.org/docs/app/building-your-application/optimizing/metadata */}
      <head>
        {/* FIXME: <Script /> does NOT work yet for this, use a better method then this <script> when available */}
        <script
          id="init-theme"
      ...
      >
        {/* App wrapper, to ensure nothing is injected in the layout, by Next.js for example */}
        <div
          id="app"
        ...
        >
          ...
          <div className="z-10 flex justify-end gap-4 p-2 px-4 sm:self-end">
            ...
            <a
              href="https://github.com/MaoDeMatos/next-13-boilerplate"
              target="_blank"
